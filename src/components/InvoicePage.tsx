...
const InvoicePage: FC<Props> = ({ data, pdfMode }) => {
  ...
  const [numDate, setNumDate] = useState<string>()
  ...
  useEffect(() => {
    ...
    const newDate = moment().format('DD-MM-YYYY').split('-')
    setNumDate(`${newDate[0]}${newDate[1]}${newDate[2]}`)
        ...
        <View className="flex mt-40" pdfMode={pdfMode}>
          ...
          <View className="w-45" pdfMode={pdfMode}>
            ...
            <View className="flex mb-5" pdfMode={pdfMode}>
              ...
              <View className="w-60" pdfMode={pdfMode}>
                <EditableCalendarInput
                  value={format(invoiceDate, 'dd-MMMM-yyyy', {locale: ptBR})}
                  selected={invoiceDate}
                  onChange={(date) =>
                    handleChange(
                      'invoiceDate',
                      date && !Array.isArray(date) ? format(date, 'dd-MMMM-yyyy', {locale: ptBR}) : ''
                    )
                  }                  
                  pdfMode={pdfMode}
                />
            ...
            <View className="flex mb-5" pdfMode={pdfMode}>
              ...
              <View className="w-60" pdfMode={pdfMode}>
                <EditableCalendarInput
                  value={format(invoiceDueDate, 'dd-MMMM-yyyy', {locale: ptBR})}
